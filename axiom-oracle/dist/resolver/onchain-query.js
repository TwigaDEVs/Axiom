...
exports.OnchainQueryFetcher = void 0;
const PUBLIC_RPCS = {
...
class OnchainQueryFetcher {
    async fetch(spec) {
        try {
            const chain = (spec.chain || "ethereum").toLowerCase();
            ...
            const contractAddress = spec.contract_address;
...
exports.OnchainQueryFetcher = OnchainQueryFetcher;
//# sourceMappingURL=onchain-query.js.map